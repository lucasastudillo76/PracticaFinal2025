...
namespace ProyectoCoop1._0.Controllers
{
    ...
    public class TurnoesController : Controller
    {
        ...
        public async Task<IActionResult> CreateTurnoSocio(Turno turno)
        {
            ...
            if (turno.FechaHora.Hour < 7 || turno.FechaHora.Hour > 11)
                ModelState.AddModelError("FechaHora", "La hora debe estar entre las 07:00 y las 11:00.");
        ...
        public async Task<IActionResult> Edit(int id, [Bind("id,estado")] Turno turnoInput)
        {
            ...
            if (turnoEnDb.estado == "Pendiente" && turnoInput.estado == "Finalizado")
            {
                turnoEnDb.estado = "Finalizado";
            ...
            ModelState.AddModelError("estado", "Solo se puede cambiar el estado de Pendiente a Finalizado.");
